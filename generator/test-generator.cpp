...
int main() {
	std::string namesPath = "datasets/firstnames.txt";
	std::string lastnamesPath = "datasets/lastnames.txt";
	std::string outPath = "register-dataset.txt";
	const int N = 1e5;

	RegisterGenerator gen(namesPath, lastnamesPath, outPath);
	gen(N);
